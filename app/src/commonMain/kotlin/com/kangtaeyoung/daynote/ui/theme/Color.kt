...
// 톤 서피스 계열(M3 1.2+). 미지정 시 기본 라벤더가 새어 NavigationBar 등이 보라로 뜬다 → 웜 톤으로 덮는다.
val LightSurfaceContainerLowest  = Color(0xFFFBF8F1)
val LightSurfaceContainerLow     = Color(0xFFF0ECE3)
val LightSurfaceContainer        = Color(0xFFEAE5DA)
val LightSurfaceContainerHigh    = Color(0xFFE4DFD4)
val LightSurfaceContainerHighest = Color(0xFFDED9CD)
val LightSurfaceBright           = Color(0xFFF5F2EA)
val LightSurfaceDim              = Color(0xFFDAD5C8)
...
// 톤 서피스 계열(웜 차콜 램프) — 라이트와 동일한 이유로 명시 지정.
val DarkSurfaceContainerLowest  = Color(0xFF141210)
val DarkSurfaceContainerLow     = Color(0xFF211E1A)
val DarkSurfaceContainer        = Color(0xFF262320)
val DarkSurfaceContainerHigh    = Color(0xFF302C26)
val DarkSurfaceContainerHighest = Color(0xFF3B372F)
val DarkSurfaceBright            = Color(0xFF413D37)
val DarkSurfaceDim               = Color(0xFF1A1815)
